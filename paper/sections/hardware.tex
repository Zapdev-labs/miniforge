...
The M7Config class encapsulates hardware-specific optimizations:

\begin{lstlisting}[language=Python, caption=M7Config Hardware-Specific Settings]
@dataclass
class M7Config:
    # CPU settings optimized for Ryzen 7 PRO 6850H
    n_threads: int = 8  # Physical cores
    n_batch: int = 2048  # Tuned for DDR5 bandwidth
    n_ubatch: int = 512  # L2 cache friendly
    
    # Memory limits
    max_memory_gb: float = 24.0
    reserve_memory_gb: float = 4.0
    
    # TurboQuant for memory efficiency
    ...
    use_mmap: bool = True
    use_mlock: bool = False  # WSL2 limitation
\end{lstlisting}
