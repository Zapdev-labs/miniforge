...
Miniforge provides KV cache monitoring:

\begin{lstlisting}[language=Python, caption=KV Cache Monitoring]
# Register cache allocation
memory_manager.register_kv_memory(
    context_tokens=194560,
    kv_type="turbo3"
)

# Get cache statistics
stats = model.get_memory_stats()
print(f"KV Cache: {stats.kv_cache_gb:.2f} GB")
print(f"Model: {stats.model_memory_gb:.2f} GB")
